            ...
            <div class="justify-content-center">
                <div class="card-body">
                    <div class="d-grid gap-2 col-12 mx-auto">
                        ...
                        <div class="row gap-2 col-12 mx-auto">
                            <asp:Button ID="ButtonReabrirIncidente" runat="server" class="btn btn-success" Text="Reabrir incidente" OnClick="ButtonReabrirIncidente_Click" Visible="false" AutoPostBack="true" />
                            <asp:Button ID="ButtonReabrir" runat="server" class="btn btn-success" Text="Aceptar" OnClick="ButtonReabrir_Click" Visible="false" AutoPostBack="true" />
